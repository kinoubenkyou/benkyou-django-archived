...
class UserFunctionalTest(StaticLiveServerTestCase):
    ...
    def test_user_create(self):
        ...
        self.web_driver.find_element(By.XPATH, "//input[@name=\"email\"]").send_keys(email)
        self.web_driver.find_element(By.XPATH, "//input[@name=\"name\"]").send_keys(name)
        self.web_driver.find_element(By.XPATH, "//input[@name=\"password1\"]").send_keys(password)
        self.web_driver.find_element(By.XPATH, "//input[@name=\"password2\"]").send_keys(password)
